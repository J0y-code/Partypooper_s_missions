...
class GUI:
    def __init__(self, rootParent=None):
        ...
        self.frame_for_bar.setShaderOff
        self.weapon_info.setShaderOff
        self.ball_in.setShaderOff
        self.ball_out.setShaderOff
        self.hp_bar.setShaderOff
        self.stamina_bar.setShaderOff
